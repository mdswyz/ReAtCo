...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    print('Total param:', sum(p.numel() for p in unet.parameters()))
    print('Trainable param:', sum(p.numel() for p in unet.parameters() if p.requires_grad))
                ...
                if global_step % validation_steps == 0:
                    if accelerator.is_main_process:
                        ...
                        for idx, prompt in enumerate(validation_data.prompts):
                            ...
                            save_videos_grid(sample, f"{output_dir}/samples/sample-{global_step}/{prompt}.gif", need_mp4=True)
